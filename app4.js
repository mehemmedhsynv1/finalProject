...
let xronoNum1 = document.querySelector("#xrono-num1");
let xronoNum2 = document.querySelector("#xrono-num2");
let xronoNum3 = document.querySelector("#xrono-num3");
let xronoNum4 = document.querySelector("#xrono-num4");
// xronoNum.forEach((a)=>{
//    window.addEventListener("scroll", ()=>{
...
let int4 = setInterval(() => {
  d+=20;
  xronoNum4.innerHTML = d;
  if(d == 10000){
    xronoNum4.innerHTML = "10,000";
    clearInterval(int4);
  }
}, 1)
